...
export default function PmContent({ email, id, projects, designers }) {
      ...
      <main className="flex-1 p-10 overflow-auto">
        {section === 'home' && (
          <div className="text-center mt-20">
            <h1 className="text-4xl font-extrabold text-gray-700 mb-4">
              Bienvenido a tu panel, Project Manager 👋
            </h1>
        ...
        {section === 'projects' && (
          <div className="max-w-4xl mx-auto">
            <ProjectTable projects={projects} editable assignable designers={designers} />
          </div>
        )}
      </main>
    </div>
